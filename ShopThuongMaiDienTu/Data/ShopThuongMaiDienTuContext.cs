...
namespace ShopThuongMaiDienTu.Data;

public partial class ShopThuongMaiDienTuContext : DbContext
{
    public ShopThuongMaiDienTuContext(DbContextOptions<ShopThuongMaiDienTuContext> options)
        : base(options)
    {
    }
