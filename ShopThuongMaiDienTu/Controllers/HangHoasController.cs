...
namespace ShopThuongMaiDienTu.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(ShopThuongMaiDienTuContext context)
        {
            _context = context;
        }
        ...
        {
            var shopThuongMaiDienTuContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await shopThuongMaiDienTuContext.ToListAsync());
        }
